    ...
    <form action="javascript:;" method="post">
        <table class="add_tab">
                    ...
                    <select name="cate_id">
                        ...
                        foreach ($list as $k => $v){
                            if($data['cate_id'] == $v['cate_id']){
                                echo "<option value=".$v['cate_id']." selected>".$v['cate_name']."</option>";
                            }else{
            ...
            <tr>
                <th>作者：</th>
                <td>
                    <input type="text" name="art_author" value="<?php echo $data['art_editor']?>">
                </td>
            </tr>
            <tr>
                <th>缩略图：</th>
                <td>
                    <input type="text" size="50" name="art_thumb" value="<?php echo $data['art_thumb']?>">
...
//                                    alert(data);
                    ...
                    <img src="<?php echo $data['art_thumb']?>" id="art_thumb_img" width="50px">
                </td>
                <br>
            ...
            <tr>
                ...
                <td>
                    ...
                    <script id="editor" name="art_content" type="text/plain" style="width:860px;height:500px;"><?php echo $data['art_content']?></script>
                    <script type="text/javascript">
